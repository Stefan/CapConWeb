...
const privacy: LegalSection[] = [
  ...
  {
    heading: "5. Analítica web (Google Analytics 4)",
    paragraphs: [
      "Si acepta todas las cookies, usamos Google Analytics 4 (Google Ireland Ltd.) para medir visitas agregadas y orígenes de referencia. Las direcciones IP se anonimizan. Base jurídica (UE/EEE): art. 6(1)(a) RGPD — consentimiento. Puede retirar el consentimiento en la configuración de cookies.",
    ],
  },
  {
