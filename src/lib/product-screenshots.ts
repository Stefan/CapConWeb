...
export const heroScreenshotByVariant: Record<SiteVariant, string> = {
  ...
  "sap-rollup": "/screenshots/financials-reconciliation.png",
  "fmcg-sap": "/screenshots/portfolio-command-center.png",
...
export const heroScreenshotCrop: Record<SiteVariant, ScreenshotCrop> = {
  ...
  "sap-rollup": { objectPosition: "left top", scale: 1 },
  "fmcg-sap": { objectPosition: "left top", scale: 1 },
